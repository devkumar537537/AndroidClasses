package com.cbitss.qrcodescanners;
...
public class QrcodeScanActivity extends AppCompatActivity {
    ...
    private void intialisecamerasource() {
        ...
        surfaceView.getHolder().addCallback(new SurfaceHolder.Callback() {
            ...
            public void surfaceCreated(@NonNull SurfaceHolder surfaceHolder) {
                ...
                if (ActivityCompat.checkSelfPermission(getApplicationContext(), Manifest.permission.CAMERA) == PackageManager.PERMISSION_GRANTED) {
                    ...
                    Toast.makeText(QrcodeScanActivity.this, "camera permission not granted", Toast.LENGTH_SHORT).show();
                }
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
                Toast.makeText(QrcodeScanActivity.this, "Scanner released", Toast.LENGTH_SHORT).show();
            }
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                {
                    Toast.makeText(QrcodeScanActivity.this, "Data not found", Toast.LENGTH_SHORT).show();
                }

...
StringRequest stringRequest = new StringRequest(Request.Method.GET, "https://script.google.com/macros/s/AKfycbyR8UFCb_bMY_hZivsFr1vslVUHsbIjtRpixlpyrCOtHKR_MchLHXUmcwwu_zXDS-9eNA/exec?action=delete&id="+id,
    ...
    private void updatedata() {
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbyR8UFCb_bMY_hZivsFr1vslVUHsbIjtRpixlpyrCOtHKR_MchLHXUmcwwu_zXDS-9eNA/exec",
                new Response.Listener<String>() {
                    @Override
                    public void onResponse(String response) {

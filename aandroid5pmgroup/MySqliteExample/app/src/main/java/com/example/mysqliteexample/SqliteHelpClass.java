...
public class SqliteHelpClass extends SQLiteOpenHelper {
    ...
    public SqliteHelpClass(@Nullable Context context) {
    ...
    public  boolean updatadata(String id,String name,String surname,String marks)
    {
        ...
        contentValues.put(SURNAME,surname);
        contentValues.put(MARKS,marks);
        int restult = db.update(TABLE_NAME,contentValues,"ID = ?",new String[] {id});
if(restult < 0)
{
    return false;
}else

...
public class Regsiteruser extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_regsiteruser);
        bindview();
 ...
 if(task.isSuccessful())
 {
     ...
     Toast.makeText(Regsiteruser.this, "UserCreated Successfully", Toast.LENGTH_SHORT).show();
     startActivity(new Intent(Regsiteruser.this,HomeActivity.class));
 }else
 {
     progressBar.setVisibility(View.GONE);
     Toast.makeText(Regsiteruser.this, "error"+task.getException(), Toast.LENGTH_SHORT).show();
 }
               }
           });

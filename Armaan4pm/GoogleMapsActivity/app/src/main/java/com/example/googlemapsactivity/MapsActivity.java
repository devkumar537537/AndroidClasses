...
public class MapsActivity extends AppCompatActivity implements OnMapReadyCallback , LocationListener,GoogleApiClient.ConnectionCallbacks,GoogleApiClient.OnConnectionFailedListener {
     ...
     setContentView(R.layout.activity_maps);
        ...
        searchlocation.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
             String cityname = locationedit.getText().toString().trim();
    ...
    private void searchlocations(String cityname) {
...
String pincode = addressList.get(0).getPostalCode().toString();
        String city = addressList.get(0).getLocality();
        String subcity = addressList.get(0).getSubLocality();

        Toast.makeText(this, "mylocation "+city+" \n  code => "+pincode+ "\n subcity => "+subcity, Toast.LENGTH_LONG).show();
        ...
        markerOptionss.title("Currentcity");

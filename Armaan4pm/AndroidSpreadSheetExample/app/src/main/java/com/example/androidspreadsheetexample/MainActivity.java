...
public class MainActivity extends AppCompatActivity {
    ...
    private void insertdata(String name_text, String numbet_text) {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, "https://script.google.com/macros/s/AKfycbz9qyzBylZ428EAyPpvvJiPOnods6ifNBfLSziiLstW53apHjoWNFJUWIN2bLzcw38MLw/exec"
            ...
            protected Map<String, String> getParams()  {
                ...
                mydata.put("action","addItem");
                mydata.put("name",name_text);
                mydata.put("number",numbet_text);

    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        MobileAds.initialize(this, new OnInitializationCompleteListener() {
            ...
            public void onInitializationComplete(InitializationStatus initializationStatus) {
                Toast.makeText(FullScreenAds.this, "Inialised", Toast.LENGTH_SHORT).show();
            }
        });
        ...
        InterstitialAd.load(this, "ca-app-pub-3940256099942544/1033173712", adIRequest, new InterstitialAdLoadCallback() {
            ...
            public void onAdFailedToLoad( LoadAdError loadAdError) {
                ...
                Toast.makeText(FullScreenAds.this, "some error"+loadAdError.getMessage(), Toast.LENGTH_SHORT);
            }
        });

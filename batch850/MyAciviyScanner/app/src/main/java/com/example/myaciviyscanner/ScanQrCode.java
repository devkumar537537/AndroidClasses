...
btnaciton.setOnClickListener(new View.OnClickListener() {
    ...
    private void intialisebarcode() {
        ...
        barcodeDetector.setProcessor(new Detector.Processor<Barcode>() {
            @Override
            public void release() {
                Toast.makeText(ScanQrCode.this, "barcode release for security reasons", Toast.LENGTH_SHORT).show();
            }
            ...
            public void receiveDetections(Detector.Detections<Barcode> detections) {
                ...
                {
                    Toast.makeText(ScanQrCode.this, "there is no value in barcode", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
